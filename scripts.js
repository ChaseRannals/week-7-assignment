...
//2. Create an array called names that contains the following values: 'Sam', 'Tommy', 'Tim', 'Sally', 'Buck',
//   'Bob'.
...
//Answer: By using the - 1 index.  By using the array[array.length - 1], you can access the last element in the array.



//4. How do you access the first element of any array?
//Answer: By using the 0 index.  By using the array[0], you can access the first element in the array.
...
//to itself n number of times. (i.e. if I pass in 'Hello' and 3, I would expect the function to 
